...
class PlayLocalScreen extends StatefulWidget {
  const PlayLocalScreen({super.key});

  @override
  State<PlayLocalScreen> createState() => _PlayLocalScreenState();
}

class _PlayLocalScreenState extends State<PlayLocalScreen> {
  var player1;
  var player2;
  var activePlayer = '1';
